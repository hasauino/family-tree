...
PWA_APP_SHORTCUTS = [{"name": "from-to", "url": "/navigation", "description": "Show tree from ancestor to child"}]
PWA_APP_SCREENSHOTS = [{"src": "/static/splash_screen_640.png", "sizes": "640x1136", "type": "image/png"}]
